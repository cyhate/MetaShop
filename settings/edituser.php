...
$sql = "UPDATE user_login SET username='$username', password='$password', country='$country', email='$email', telephone='$telephone' WHERE userid LIKE '".$_POST["currentid"]."%' AND username LIKE '".$_POST["currentname"]."%' ";
...
if (mysqli_query($con,$sql)) {
    ...
    echo 'document.location.href="http://localhost/MetaShop/settings/account_settings.html";';
    echo '</script>';
